...
<div class="tabela-container">
    ...
    <p class="subtitulo-adm">Solicitação de Pedidos</p>
    <table class="tabela">
        <thead>
            <tr>
                <th>Nome</th>
                ...
                <th>Status</th>
                <th>Solicitação</th>
               <!--  <th><textarea name="" id="" cols="30" rows="10"></textarea></th> -->
            </tr>
        </thead>
        <tbody>
        <?php while($pedido=mysqli_fetch_assoc($row)){ 
   ?>
            <tr>
                <td data-label="nome"> <?php echo $pedido['nome'] ?></td>
                <td data-label="email"> <?php echo $pedido['email'] ?></td>
                <td data-label="telefone"> <?php echo $pedido['tel'] ?></td>
                <td data-label="data"><?php echo $pedido['dia'] ?> </td>
                <td data-label="tema"><?php echo $pedido['tema'] ?> </td>
                <td data-label="descricao" class="desc-admin"> <?php echo $pedido['descricao'] ?></td>
                <td data-label="status"><span class="text_open">[ <?php echo $pedido['status'] ?> ]</span></td>
                <td data-label="#"> <a href="formPedido.php?id=<?php echo $pedido['id'] ?>" class="btn-admin">Visualizar</a></td>
            </tr>
