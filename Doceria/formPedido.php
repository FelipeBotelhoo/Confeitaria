        ...
        <div class="formulario">
            <div class="form">
                <div class="form-titulo">
                    <div class="titulo">
                        <h1>Solicitação de Pedidos</h1>
                    </div>
                </div>
                <form class="row g-3" action="action/upSit.php" method="post">
                 
                    <input name="id" value="<?php echo $resultado['id'];?>" hidden>

                    <div class=" input-caixa col-md-12">
                        <label for="nome" class="form-label">Nome Completo</label>
                        <input type="text" required minlength="8" maxlength="50" value="<?php echo $resultado['nome'];?>">
                    </div>
                    <div class=" input-caixa col-md-6">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" required minlength="8" maxlength="50" value="<?php echo $resultado['email'];?>">
                    </div>


                    <div class="input-caixa  col-md-4">
                        <label for="telefone" class="form-label">Telefone</label>
                        <input type="text" placeholder="Digite seu Telefone com DDD" required minlength="10"
                            maxlength="11" value="<?php echo $resultado['tel'];?>">
                    </div>

                    <div class=" input-caixa col-md-4">
                        <label for="inputState" class="form-label" >Tema Festa</label>
                        <input type="text" placeholder="Tema" required minlength="10"
                            maxlength="11" value="<?php echo $resultado['tema'];?>">
                    </div>
                    <div class=" input-caixa col-md-2">

                        <label for="date">Data do Evento</label>
                        <input id="data" type="text" name="data" value="<?php echo $resultado['dia'];?>" required >

                    </div>
                    <div class="area-texto col-12">
                        <textarea rows="10" cols="45" placeholder="Descreva o seu pedido" ><?php echo $resultado['descricao'];?></textarea>
                    </div>

                    <div class=" input-caixa col-md-4">
                        <label for="inputState" class="form-label">Resposta</label>
                        <select name="sit">
                            <option selected>...</option>
                            <option value="Aceito">Aceitar Pedido</option>
                            <option value="Recusado">Recusar Pedido</option>
                        </select>
                    </div>
